...
let status1 = prompt("Enter Task 1 status (todo, doing, done):").toLowerCase(); // Check if the user entered a status
...
let status2 = prompt("Enter Task 2 status (todo, doing, done):").toLowerCase(); // Check if the user entered a status
